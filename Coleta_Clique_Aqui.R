...
dados_lojas_feira <- pegar_dados(local = "Feira de Santana", termo = "Loja de artigos domésticos", scrolls = 2)
...
# Exportar para Excel
write_xlsx(dados_lojas_feira, "loc_dados_lojas_de artigos domésticos_feira.xlsx")
