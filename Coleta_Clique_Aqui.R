...
dados_lojas_feira <- pegar_dados(local = "Feira de Santana", termo = "Loja de variedades", scrolls = 2)
...
# Exportar para Excel
write_xlsx(dados_lojas_feira, "dados_lojas_de variedades_feira.xlsx")
